// NOTE: UI COMPONENTS
// Reusable canvas drawing pieces for Sparkle Seeker.
//
// Owned here:
// - shared draw primitives
// - reusable menu/button/panel components
// - rich text helpers
// - HUD drawing
// - touch button drawing
// - background and fog drawing
//
// NOT owned here:
// - screen state / mode logic
// - title color engine state
// - theme creation / CSS token reading
// - screen-level rendering orchestration
//
// Newbie note:
// - This file answers "how do we draw this reusable UI piece?"
// - If code decides which screen is active, it belongs in `ui_mode.js`.
// - If code defines colors/fonts/sizes/layout rules, it belongs in `ui_config.js`.
// - If code draws an entire screen flow, it belongs in `ui_draw.js`.
